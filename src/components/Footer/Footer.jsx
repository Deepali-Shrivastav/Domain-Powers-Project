...
import logo from '../../assets/images/domain_powers.logo.png';
import './Footer.css';
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              <li><Link to="/products#1">LT APFC Panels</Link></li>
              <li><Link to="/products#3">HT APFC Panels</Link></li>
              <li><Link to="/products#4">Hybrid Systems</Link></li>
              <li><Link to="/products#8">Motor Starters</Link></li>
              <li><Link to="/products#5">Distribution Centers</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/contact">Site Visit</Link></li>
            </ul>
          </div>
